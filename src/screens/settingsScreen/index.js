        ...
        <View className="h-screen flex items-center justify-around bg-gray-700">
            <View className="w-11/12 bg-gray-400 rounded-lg">
                <View className="w-full">
                    <Text className="flex items-center justify-between h-16 text-center text-xl text-black">
                        Notifikationer
            ...
            <View className="w-11/12 bg-gray-400 rounded-lg">
                ...
                <View className="w-full">
                    <Text className="text-center text-black">Välj vilken ikon som ska visas på din telefon. Bara appens ikon kommer ändras <Text className="font-bold">inte appens namn</Text></Text>
                </View>
                <View className="flex flex-wrap justify-around items-center w-full h-1/4">
                    <Image source={{ uri: "https://i.pinimg.com/736x/e6/e9/3f/e6e93f7bd4f95000d9f56a3c096047d0.jpg" }} style={{ width: 80, height: 80 }} />
                    <Image source={{ uri: "https://i.pinimg.com/736x/e6/e9/3f/e6e93f7bd4f95000d9f56a3c096047d0.jpg" }} style={{ width: 80, height: 80 }} />
                    <Image source={{ uri: "https://i.pinimg.com/736x/e6/e9/3f/e6e93f7bd4f95000d9f56a3c096047d0.jpg" }} style={{ width: 80, height: 80 }} />
                    <Image source={{ uri: "https://i.pinimg.com/736x/e6/e9/3f/e6e93f7bd4f95000d9f56a3c096047d0.jpg" }} style={{ width: 80, height: 80 }} />
                    <Image source={{ uri: "https://i.pinimg.com/736x/e6/e9/3f/e6e93f7bd4f95000d9f56a3c096047d0.jpg" }} style={{ width: 80, height: 80 }} />
